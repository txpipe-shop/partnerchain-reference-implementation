...
The development logs are also available as PDfs in the [developer_reference](./docs/developer_reference_pdf/) directory: [initial customizations](./docs/developer_reference_pdf/initial_customizations.pdf), [partner chain integration](./docs/developer_reference_pdf/partner_chain_integration.pdf) and [use case implementation](./docs/developer_reference_pdf/use_case_implementation.pdf).
