...
mod tests {
    ...
    use sidechain_domain::{
        byte_string::ByteString, McBlockNumber, McSlotNumber, McTxHash, McTxIndexInBlock,
    ...
    async fn ariadne_parameters_returns_correct_json_string() {
        ...
        let cmd_output = cli_get_ariadne_parameters(query, McEpochNumber(303))
            .await
            .unwrap();
    ...
    async fn cli_get_registration_status_returns_correct_json_string() {
        let aura = ByteString::from_hex_unsafe(
            "90b5ab205c6974c9ea841be688864633dc9ca8a357843eeacf2314649965fe22",
        );
        let grandpa = ByteString::from_hex_unsafe(
            "439660b36c6c03afafca027b910b4fecf99801834c62a5e6006f27d978de234f",
        );
