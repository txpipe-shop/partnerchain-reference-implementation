...
mod tests {
    ...
    fn constructor_datums_to_cbor() {
        ...
        let small_empty = ConstructorDatum {
            constructor: 2,
            fields: Vec::new(),
        };
        let small_non_empty = ConstructorDatum {
            constructor: 2,
            fields: make_fields(3),
        };
        let big_empty = ConstructorDatum {
            constructor: 34,
            fields: Vec::new(),
        };
        let big_non_empty = ConstructorDatum {
            constructor: 34,
            fields: make_fields(2),
        };
        let over_limit_empty = ConstructorDatum {
            constructor: 130,
            fields: Vec::new(),
        };
        let over_limit_non_empty = ConstructorDatum {
            constructor: 130,
    ...
    fn list_datums_to_cbor() {
        ...
        test(
            ListDatum(vec![ByteStringDatum(hex::decode("deadbeef").unwrap())]),
            "9f44deadbeefff",
        );
        test(
            ListDatum(vec![
    ...
    fn map_datums_to_cbor() {
        ...
        test(
            MapDatum(vec![
                MapDatumEntry {
                    key: Datum::integer(99),
                    value: Datum::integer(101),
                },
                MapDatumEntry {
