...
mod tests {
    ...
    pub(crate) const TEST_PARAMS: UtxoId = UtxoId {
        tx_hash: McTxHash(hex!(
            "8ea10040249ad3033ae7c4d4b69e0b2e2b50a90741b783491cb5ddf8ced0d861"
        )),
    ...
    pub(crate) fn scripts_data_test_vector() -> ScriptsData {
        ScriptsData {
            addresses: Addresses {
                ...
                illiquid_circulation_supply_validator:
                    "addr_test1wr6e3h6crn97w8c2fjsw9aqaxyvm8qvny6vwd9w0444v92gk0mgf5".into(),
                reserve_validator:
            ...
            policy_ids: PolicyIds {
                ...
                illiquid_circulation_supply_auth_token: PolicyId(hex!(
                    "904868d6ec966b9a5a5b4bdd73858a17792821e10e99236c63c3b533"
                )),
            },
        }
    }
