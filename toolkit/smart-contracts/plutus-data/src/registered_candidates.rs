...
use crate::{
    candidate_keys::*, PlutusDataExtensions, VersionedDatum, VersionedDatumWithLegacy,
...
mod tests {
    ...
    fn valid_legacy_registration() {
        ...
        assert_eq!(
            RegisterValidatorDatum::try_from(plutus_data).unwrap(),
            test_datum_v0()
        )
    }
    ...
    fn v0_registration_to_plutus_data() {
        ...
        assert_eq!(
            plutus_data_to_json(plutus_data),
            test_versioned_datum_v0_json()
        )
    }
