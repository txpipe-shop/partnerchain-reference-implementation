...
use crate::{
    decoding_error_and_log, DataDecodingError, DecodingResult, PlutusDataExtensions, ScriptHash,
};
    ...
    fn decoding() {
        ...
        let expected_datum = VersionOracleDatum {
            version_oracle: VersionOracle {
                script_id: ScriptId::GovernancePolicy as u32,
            },
        ...
        assert_eq!(
            VersionOracleDatum::try_from(plutus_data).unwrap(),
            expected_datum
        )
    }
