...
impl CmdRun for Register1Cmd {
    fn run<C: IOContext>(&self, context: &C) -> anyhow::Result<()> {
        ...
        let registration_utxo: UtxoId = select_from_utxos(
            context,
...
pub fn read_generated_keys<C: IOContext>(context: &C) -> anyhow::Result<GeneratedKeysFileContent> {
    ...
    let GeneratedKeysFileContentRaw {
        partner_chains_key,
        keys: raw_keys,
...
mod tests {
    ...
    fn happy_path() {
        ...
        let mock_context = MockIOContext::new()
            ...
            .with_json_file(
                ...
                resource_config_without_cardano_fields,
            )
    ...
    fn utxo_query_error() {
        ...
        assert_eq!(
            ...
            "Ogmios request failed!".to_owned()
        );
    }
...
"#;
    ...
    fn ogmios_network_request_io() -> MockIO {
        MockIO::ogmios_request(
            ...
            Ok(ogmios::OgmiosResponse::QueryNetworkShelleyGenesis(
