...
pub fn prepare_main_chain_config<C: IOContext>(
    ...
    if INITIAL_PERMISSIONED_CANDIDATES
...
mod tests {
    ...
    use crate::tests::{
        MockIO, MockIOContext, OffchainMock, OffchainMocks, CHAIN_CONFIG_FILE_PATH,
        ...
        let mock_context = MockIOContext::new()
            ...
            .with_expected_io(vec![
                MockIO::ogmios_request(
                    ...
                    Ok(OgmiosResponse::QueryLedgerStateEraSummaries(
                ...
                MockIO::ogmios_request(
                    ...
                    Ok(OgmiosResponse::QueryNetworkShelleyGenesis(
