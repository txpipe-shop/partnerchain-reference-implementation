...
pub const AURA: KeyDefinition<'static> = KeyDefinition {
    name: "AURA",
    scheme: "sr25519",
    key_type: "aura",
};
/// Well known definition of Grandpa key
pub const GRANDPA: KeyDefinition<'static> = KeyDefinition {
    name: "Grandpa",
    scheme: "ed25519",
    key_type: "gran",
};
/// Definition of Partner-chains key
pub const CROSS_CHAIN: KeyDefinition<'static> = KeyDefinition {
    name: "Cross-chain",
    scheme: "ecdsa",
    key_type: "crch",
};
