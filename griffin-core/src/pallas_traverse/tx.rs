...
impl<'b> MultiEraTx<'b> {
    ...
    pub fn as_babbage(&self) -> Option<&babbage::MintedTx<'_>> {
        match self {
    ...
    pub fn as_alonzo(&self) -> Option<&alonzo::MintedTx<'_>> {
        match self {
    ...
    pub fn as_byron(&self) -> Option<&byron::MintedTxPayload<'_>> {
        match self {
    ...
    pub fn as_conway(&self) -> Option<&conway::MintedTx<'_>> {
        match self {
